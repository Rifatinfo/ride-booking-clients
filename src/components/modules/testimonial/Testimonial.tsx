          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative mt-10 md:mt-24 md:order-2">
              <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                <div
                  className="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter bg-gradient-to-r from-[#ee9999] via-[#9ed2f7] via-[#ecc7c7] via-[#ff6644] to-[#f08d8d]"
                ></div>
              </div>
